<a href="https://lockurl.dopesatan.in/"><img src="https://bit.ly/3ZRfJEy"></a>
...
#### [✅ Click here to see working example of a LockURL link.](https://lockurl.dopesatan.in/#eyJ2IjoiMC4wLjEiLCJlIjoiSGZlcHBodFJvZjgrYm55ZlR6Qkx4RlJWMEdvdXUxRWxIUHFweStNaWg2RTVKU2F1YjQweDhRPT0iLCJoIjoiMSsxPT8g8J+YgyIsInMiOiIrSHNnd3FsSUZHMVk0c2lrcmY2TjVRPT0iLCJpIjoiU2h5RzNUdjJsdmljaWNKRyJ9)
 
## 🛠️ Usage Guide
- Create a password protected link from [here](https://lockurl.dopesatan.in/).
...
- Currently, the only way to recover a lost password is by trying all possible options very slowly by brute force. An example application to brute force LockURL links in the browser can be found [here](https://lockurl.dopesatan.in/bruteforce/).
